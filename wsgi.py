...
def show_help():
    ...
    print("User Commands:")
    print("  flask user list [string|json]                      List all users")
    ...
    print("  flask employer position <employer_id> <title> <number_of_positions> <skills>  Create a position")
    ...
    print("  flask employer accept <application_id> <employer_id>                          Accept a student application")
    print("  flask employer reject <application_id> <employer_id>                          Reject a student application\n")
    print("Test Commands:")
    print("  flask test user [unit|int|all]                        Run user tests")
